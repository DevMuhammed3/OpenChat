                ...
                <div className="flex flex-col min-h-full justify-end">
                    ...
                    {messages.map((message, index) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    {message.fileUrl && (
                                        <img
                                            src={message.fileUrl}
                                            className="mt-2 rounded-lg max-h-80 ring-1 ring-white/10"
                                        />
                                    )}
                                </div>
                            )
                        ...
                        return (
                            <div
                                key={message.id}
                                className="flex gap-4 px-4 py-3 hover:bg-white/[0.02] transition-colors mt-2"
                            >
                ...
                <div className="bg-white/[0.04] rounded-lg p-2.5 flex flex-col gap-2 shadow-lg ring-1 ring-white/5 focus-within:ring-white/10 transition-shadow">
                    {previewUrl && (
                        <div className="relative w-24 h-24 mb-2 group">
                            <img
                                src={previewUrl}
                                className="w-full h-full object-cover rounded-md ring-1 ring-white/10"
                            />
                            <button
